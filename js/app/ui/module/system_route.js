...
define([
    ...
    let getRouteRequestDataFromRowData = (rowData) => {
        return {
            ...
            wormholes: (rowData.hasOwnProperty('wormholes')) ? rowData.wormholes | 0 : 0,
            wormholesReduced: (rowData.hasOwnProperty('wormholesReduced')) ? rowData.wormholesReduced | 0 : 0,
            wormholesCritical: (rowData.hasOwnProperty('wormholesCritical')) ? rowData.wormholesCritical | 0 : 0,
            wormholesFrigate: (rowData.hasOwnProperty('wormholesFrigate')) ? rowData.wormholesFrigate | 0 : 0,
            wormholesEOL: (rowData.hasOwnProperty('wormholesEOL')) ? rowData.wormholesEOL | 0 : 0,
